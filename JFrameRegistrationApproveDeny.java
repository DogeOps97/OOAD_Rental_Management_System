 ...
 * @author user
 */
public class JFrameRegistrationApproveDeny extends javax.swing.JFrame {

    /**
     * Creates new form JFrameRegistrationApproveDeny
     */
    public JFrameRegistrationApproveDeny() {
        initComponents();
        this.setLocationRelativeTo(null);
    }
    
    private Admin admin;
    public JFrameRegistrationApproveDeny(Admin admin) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Registration - Approve / Deny");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String userRole_field = jTextField6.getText();
        ...
        int statusReturn = admin.modifyRegistration(userID, userName_field, userPassword_field, userRealName_field, userContact_field, userRole_field);
        
        
        switch (statusReturn) {
            case 0:
                JOptionPane.showMessageDialog(null, "User registeration approved");
                admin.approveRegistration(userID);
                break;
            case -1:
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int statusReturn = admin.deleteRegistration(userID);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameRegistrationApproveDeny.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameRegistrationApproveDeny().setVisible(true);
            }
        });
    }
